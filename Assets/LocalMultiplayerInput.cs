...
//     version 1.18.0
//     from Assets/LocalMultiplayerInput.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/LocalMultiplayerInput.inputactions".
/// </summary>
/// <remarks>
...
public partial class @LocalMultiplayerInput: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""bindings"": [
                ...
                {
                    ""name"": ""D-Pad"",
                    ""id"": ""b8c2c7b4-bc80-4ce7-8826-5c43f718d322"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""30cc50b5-2aa7-46f3-a761-911f3fe51e8f"",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""abebec4c-b9d6-4f3b-9cff-20a66c8d6f79"",
    ...
    ""controlSchemes"": [
        ...
        m_PlayerControll_Crouch = m_PlayerControll.FindAction("Crouch", throwIfNotFound: true);
        m_PlayerControll_Jump = m_PlayerControll.FindAction("Jump", throwIfNotFound: true);
        m_PlayerControll_Previous = m_PlayerControll.FindAction("Previous", throwIfNotFound: true);
        m_PlayerControll_Next = m_PlayerControll.FindAction("Next", throwIfNotFound: true);
        // UI
    ...
    {
        UnityEngine.Debug.Assert(!m_PlayerControll.enabled, "This will cause a leak and performance issues, LocalMultiplayerInput.PlayerControll.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, LocalMultiplayerInput.UI.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_PlayerControll_Crouch;
    private readonly InputAction m_PlayerControll_Jump;
    private readonly InputAction m_PlayerControll_Previous;
    private readonly InputAction m_PlayerControll_Next;
    /// <summary>
    ...
    public struct PlayerControllActions
    {
        ...
        /// </summary>
        public PlayerControllActions(@LocalMultiplayerInput wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        ...
        /// <summary>
        /// Provides access to the underlying input action "PlayerControll/Crouch".
        /// </summary>
        public InputAction @Crouch => m_Wrapper.m_PlayerControll_Crouch;
        /// <summary>
        ...
        /// <summary>
        /// Provides access to the underlying input action "PlayerControll/Previous".
        /// </summary>
        public InputAction @Previous => m_Wrapper.m_PlayerControll_Previous;
        /// <summary>
        /// Provides access to the underlying input action "PlayerControll/Next".
        /// </summary>
        public InputAction @Next => m_Wrapper.m_PlayerControll_Next;
        /// <summary>
