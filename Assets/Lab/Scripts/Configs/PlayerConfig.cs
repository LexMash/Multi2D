...
namespace Multi2D
{
    ...
    public class PlayerConfig : ScriptableObject
    {
        ...
        [field: SerializeField, Range(0.01f, 1f)] public float AxisInputTreshold { get; private set; } = 0.3f;
        ...
        [field: SerializeField, Range(1f, 50f)] public float InAirHorizontalModifier { get; private set; } = 2f;
        [field: SerializeField, Range(0.1f, 0.5f)] public float CoyoteTime { get; private set; } = 0.25f;
        [field: SerializeField, Range(1, 30)] public float MaxVerticalFallSpeed { get; private set; } = 10;
        [field: SerializeField, Range(0.01f, 10f)] public float OnGroundGravity { get; private set; } = 1f;


        [field: Space(20), Header("Jump")]
