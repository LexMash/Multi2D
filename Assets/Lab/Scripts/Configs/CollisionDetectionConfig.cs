...
namespace Multi2D
{
    ...
    public class CollisionDetectionConfig
    {
        ...
        [field: SerializeField] public Vector2 ForwardOverlapOffset { get; private set; }
        ...
        [field: SerializeField] public Vector2 TopOverlapOffset { get; private set; }
        ...
        [field: SerializeField] public Vector2 BottomOverlapOffset { get; private set; }
